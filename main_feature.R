...
preprocessed_results_by_feature <- lapply(split_results$n, preprocess_results)

# Mediation analysis for preprocessed data
results <- list()

preprocessed_data <- preprocessed_results_by_feature[["feature"]]
#i=1
...
write.csv(results_df, file = "mediation_analysis_results_feature.csv", row.names = FALSE)
...
# Save the data frame to a CSV file
write.csv(results_df, file = "mediation_analysis_results_no_mediation_effect_feature.csv", row.names = FALSE)
...
results_df <- read.csv("mediation_analysis_results_feature.csv")

# Add sample size information
results_df$sample_size <- rep(c(10, 20, 40), each = 20)
...
results_no_mediation_df <- read.csv("mediation_analysis_results_no_mediation_effect_feature.csv")

# Add sample size information
results_no_mediation_df$sample_size <- rep(c(10, 20, 40), each = 20)
