...
# read the results
output_dir <- "new method simulation_data_sample_new"
...
for (percentage in zero_percentages) { #percentage =30
  ...
  write.csv(results_df, file = paste0("sample_new_", percentage, ".csv"), row.names = FALSE)
...
for (percentage in zero_percentages) {
  ...
  print(results_df)
  # Save the data frame to a CSV file
  write.csv(results_df, file = paste0("sample_noMe_", percentage, ".csv"), row.names = FALSE)
...
power_results_10 <- generate_power_results("sample_10.csv", "10% Zero Values")
power_results_30 <- generate_power_results("sample_30.csv", "30% Zero Values")
power_results_50 <- generate_power_results("sample_50.csv", "50% Zero Values")
power_results_70 <- generate_power_results("sample_70.csv", "70% Zero Values")
